...
const ScoreCard: React.FC<ScoreCardProps> = ({
  ...
  const getPerformanceLevel = () => {
    if (percentage >= 90)
      return { level: "Excellent!", color: "text-green-600", icon: Trophy };
    if (percentage >= 70)
      return { level: "Good Job!", color: "text-blue-600", icon: Target };
    if (percentage >= 50)
      return { level: "Not Bad!", color: "text-yellow-600", icon: Star };
